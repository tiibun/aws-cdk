...
import { Action, ActionArtifactBounds, ActionCategory, CommonActionConstructProps } from "./action";
import { Artifact } from './artifact';

export interface DeployActionProps extends CommonActionConstructProps {
  provider: string;
