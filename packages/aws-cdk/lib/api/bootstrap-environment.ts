...
export async function bootstrapEnvironment(environment: Environment, aws: SDK, toolkitStackName: string, roleArn?: string): Promise<DeployStackResult> {
  ...
  return await deployStack(synthesizedStack, aws, undefined, toolkitStackName, roleArn);
}
